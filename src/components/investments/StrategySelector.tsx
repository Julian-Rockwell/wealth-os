...
const STRATEGIES: StrategyInfo[] = [
  ...
  },
  {
    id: "earnings_vip",
    name: "Earnings VIP",
    description: "Event-driven options strategies around earnings announcements.",
    minCapital: 15000,
    riskLevel: "medium",
  ...
  },
  {
    ...
    description: "Event-driven stock strategies capturing dividend payments.",
    minCapital: 2000,
    riskLevel: "low",
